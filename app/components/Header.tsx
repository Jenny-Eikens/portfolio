...
const Header = () => {
  ...
  return (
    <>
      <header className="relative mb-8 w-full pt-2">
        <div className="flex flex-col items-start">
          ...
          >
            <ul className="mt-[6rem] list-none justify-between space-y-8 p-3 text-2xl md:mt-0 md:flex md:w-full md:flex-row md:space-y-0">
              <li>
                <a href="#">// home</a>
              </li>
              <li>
